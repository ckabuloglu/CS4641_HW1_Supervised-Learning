...
plt.legend(loc='best')
fig.savefig('figures/letter_decision_trainingSize.png')
plt.close(fig)

confidence_interval = [0.0000001, 0.00001, 0.001, 0.1, 1]
accuracy = [0.842, 0.85375, 0.8655, 0.87525, 0.87725]
cv = [0.85695, 0.85775, 0.86625, 0.8741, 0.8777]

fig = plt.figure()
line1, = plt.plot(confidence_interval, cv, 'b', label="Cross Validation Score")
line2, = plt.plot(confidence_interval, accuracy, 'g', label="Testing Accuracy")
plt.xlabel('Confidence Interval')
plt.ylabel('Accuracy')
plt.title('Pruning versus Accuracy (Letter)')
plt.legend(loc='best')
fig.savefig('figures/letter_decision_pruning.png')
plt.close(fig)